...
namespace cloudsoft
{
	...
	public class Test7_Friend_Serializer : Serializer
	{
		public Test7_Friend_Serializer()
		{
			SerializerOf = typeof(Test7.Friend);
		...
		{
			return stream.WriteTest7_Friend( (Test7.Friend)value);
		}
		
		public override object Read( SerializerStream stream, System.Type type )
		{
			return stream.ReadTest7_Friend();
		}
	...
	{
		public int WriteTest7_Friend( Test7.Friend value, bool dontWriteDefault = false, int slot = -1)
		{
		...
		public Test7.Friend ReadTest7_Friend( uint subType = 0 )
		{
			if( subType == 0 )
			{
				Test7.Friend value = new Test7.Friend();
				int fieldId = 1;
				uint typeId = 1;
				while( true )
				{
			...
			throw new System.Exception("Can not ReadTest7_Friend");
		}
